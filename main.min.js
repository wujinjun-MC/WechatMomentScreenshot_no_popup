 ...
 * - /gh/TransparentLC/WechatMomentScreenshot@37c480453d7fc4a8e42bd5e918a05d4658251496/main.min.js
 *
...
!function(t, e) {
    ...
    function r(n, i) {
        ...
        s._immediateFn(function() {
            ...
            if (null !== t) {
                ...
                (1 === n._state ? a : c)(i.promise, n._value)
        })) : n._deferreds.push(i)
    }
    function a(e, t) {
        try {
    ...
    var H, L = ((H = function(t) {
        ...
        if (t instanceof R)
            return t;
        if (p(t))
            return /complete|loaded|interactive/.test(document.readyState) && document.body ? t.call(document, H) : document.addEventListener("DOMContentLoaded", function() {
    ...
    L.ajax = function(t) {
        ...
        X({}, n, e)), i = c.url || window.location.toString(), l = c.method.toUpperCase(), d = c.data, o = c.processData, h = c.async, f = c.cache, p = c.username, m = c.password, v = c.headers, g = c.xhrFields, y = c.statusCode, b = c.dataType, x = c.contentType, C = c.timeout, w = c.global;
        function $(t, e, n) {
            for (var i, o, s = [], r = arguments.length - 3; 0 < r--; )
                s[r] = arguments[r + 3];
            w && L(document).trigger(t, e),
            n && (n in J && (i = J[n].apply(J, s)),
            c[n] && (o = c[n].apply(c, s)),
            "beforeSend" !== n || !1 !== i && !1 !== o || (a = !0))
        }
        return !d || !G(l) && !o || E(d) || d instanceof ArrayBuffer || d instanceof Blob || d instanceof Document || d instanceof FormData || (d = V(d)),
        d && G(l) && (i = Q(i, d),
        d = null),
        new Promise(function(t, e) {
            ...
            s.open(l, i, h, p, m),
            (x || d && !G(l) && !1 !== x) && s.setRequestHeader("Content-Type", x),
            ...
            s.onload = function() {
                ...
                if (i)
                    ...
                    "json" === b) {
                        ...
                        "parsererror" !== r && ($(K.ajaxSuccess, u, "success", n, r, s),
                        t(n))
                    } else
    ...
    function et(t, e, n) {
        var i;
        return C(e) ? (tt(t, e),
        e) : O(n) ? O(e) ? t[Z] ? t[Z] : {} : (e = $(e),
        t[Z] && e in t[Z] ? t[Z][e] : void 0) : (tt(t, ((i = {})[e] = n,
        i)),
        n)
    }
    function nt(t, n) {
    ...
    function it(e, t) {
        if (e[Z]) {
            ...
            O(t) ? (e[Z] = null,
            delete e[Z]) : E(t) ? t.split(" ").filter(function(t) {
                return t
            }).forEach(function(t) {
                return n(t)
            }) : D(t, function(t, e) {
        ...
        return this.each(function() {
            !function(s, t, r, a, u) {
                ...
                t.split(" ").forEach(function(t) {
                    ...
                    function o(e) {
                        e._ns && !Y(e._ns).test(n.ns) || (e._data = a,
                        u ? L(s).find(u).get().reverse().forEach(function(t) {
                ...
                return this.each(function(t, e) {
                    !function(t, e, n) {
                        if (!O(n))
                            ...
                            default:
                                e = $(e),
                                t.style[e] = m(n) ? n + (-1 < A.indexOf(e) ? "" : "px") : n
                            }
    ...
    function ut(e, n, t, i, o, s) {
        ...
        T(e) ? (window.document.documentMode && 1 === s && (t += r("border"),
        t += r("padding")),
        0 === i && (t -= r("border")),
        1 === i && (t -= r("border"),
    ...
    L.fn.offsetParent = function() {
        return this.map(function() {
            for (var t = this.offsetParent; t && "static" === L(t).css("position"); )
                t = t.offsetParent;
    ...
    L.fn.offset = function(e) {
        return arguments.length ? this.each(function(t) {
            !function(t, e, n) {
                ...
                var s, r, a = dt(t), u = i.css("top"), c = i.css("left");
    ...
    L.fn.replaceWith = function(i) {
        return this.each(function(t, e) {
            var n = i;
            p(n) ? n = n.call(e, t, e.innerHTML) : t && !E(n) && (n = L(n).clone()),
            L(e).before(n)
        }),
        this.remove()
    }
    ...
    L.fn.replaceAll = function(t) {
        ...
        return L(t).map(function(t, e) {
            return L(e).replaceWith(t ? n.clone() : n),
            n.get()
        })
    }
    ,
    ...
    L.fn.show = function() {
        return this.each(function() {
            ...
            "none" === S(this, "display") && (this.style.display = (t = this.nodeName,
            ht[t] || (e = document.createElement(t),
    ...
    L.showOverlay = function(t) {
        ...
        e = L('<div class="mdui-overlay">').appendTo(document.body).reflow().css("z-index", t));
    ...
    B.mutation = function(n, i) {
        O(n) || O(i) ? L(document).mutation() : (ft[n] = i,
        L(n).each(function(t, e) {
            return pt(n, i, t, e)
        }))
    }
    ...
    It.prototype.updateThCheckbox = function() {
        ...
        this.selectable && (this.$thCheckbox = L(this.createCheckboxHTML("th")).prependTo(this.$thRow).find('input[type="checkbox"]').on("change", function() {
    ...
    function qt(t, e) {
        ...
        if (!(-1 < ["checkbox", "button", "submit", "range", "radio", "image"].indexOf(r))) {
            ...
            h && ((e.reInit || e.domLoadedEvent) && L('<div class="mdui-textfield-counter"><span class="mdui-textfield-counter-inputed"></span> / ' + h + "</div>").appendTo(a),
    ...
    L(function() {
        ...
        gt.on("click", ".mdui-textfield-expandable .mdui-textfield-icon", function() {
    ...
    Kt.prototype.readjustMenu = function() {
        var t, e, n = yt.height(), i = this.$element.height(), o = this.$items.first(), s = o.height(), r = parseInt(o.css("margin-top")), a = this.$element.innerWidth() + .01, u = s * this.size + 2 * r, c = this.$element[0].getBoundingClientRect().top;
    ...
    Kt.prototype.handleUpdate = function() {
        ...
        this.$selected = L('<span class="mdui-select-selected">' + this.selectedText + "</span>"),
        this.$element = L('<div class="mdui-select mdui-select-position-' + this.options.position + '" style="' + this.$native.attr("style") + '" id="' + this.uniqueID + '"></div>').show().append(this.$selected),
        this.$menu = L('<div class="mdui-select-menu"></div>').appendTo(this.$element).append(this.$items),
    ...
    function Zt(t, e) {
        ...
        this.$indicator = L('<div class="mdui-tab-indicator"></div>').appendTo(this.$element);
        var i = window.location.hash;
        i && this.$tabs.each(function(t, e) {
            return L(e).attr("href") !== i || (n.activeIndex = t,
            !1)
        }),
        -1 === this.activeIndex && this.$tabs.each(function(t, e) {
            return !L(e).hasClass("mdui-tab-active") || (n.activeIndex = t,
            !1)
        }),
        this.$tabs.length && -1 === this.activeIndex && (this.activeIndex = 0),
        this.setActive(),
        yt.on("resize", L.throttle(function() {
    ...
    Zt.prototype.setActive = function() {
        ...
        this.$tabs.each(function(t, e) {
            ...
            L(i).hide()) : (n.hasClass("mdui-tab-active") || (o.triggerEvent("change", o.$element, {
                index: o.activeIndex,
                id: i.substr(1)
            }),
    ...
    Zt.prototype.show = function(n) {
        var i = this;
        -1 !== this.activeIndex && (m(n) ? this.activeIndex = n : this.$tabs.each(function(t, e) {
            if (e.id === n)
                return i.activeIndex = t,
                !1
        }),
        this.setActive())
    }
    ...
    function ne(t, e) {
        ...
        yt.on("resize", L.throttle(function() {
            n.isDesktop() ? (n.overlay && !n.options.overlay && (L.hideOverlay(),
            n.overlay = !1,
            L.unlockScreen()),
            n.$element.hasClass("mdui-drawer-close") || (n.state = "opened")) : n.overlay || "opened" !== n.state || (n.$element.hasClass("mdui-drawer-open") ? (L.showOverlay(),
            n.overlay = !0,
            L.lockScreen(),
    ...
    ne.prototype.swipeSupport = function() {
        var e, s, r, a, u = this, c = null, l = !1, d = L("body"), n = 24;
        function h(t) {
        ...
        this.options.swipe && (e || (d.on("touchstart", i),
        e = i))
    }
    ,
    ...
    ne.prototype.open = function() {
        ...
        this.isOpen() || (this.state = "opening",
        this.triggerEvent("open"),
        this.options.overlay || L("body").addClass("mdui-drawer-body-" + this.position),
    ...
    ne.prototype.close = function() {
        ...
        this.isOpen() && (this.state = "closing",
        this.triggerEvent("close"),
        this.options.overlay || L("body").removeClass("mdui-drawer-body-" + this.position),
        this.$element.addClass("mdui-drawer-close").removeClass("mdui-drawer-open").transitionEnd(function() {
            return t.transitionEnd()
        }),
        this.overlay && (L.hideOverlay(),
        this.overlay = !1,
        L.unlockScreen()))
    }
    ,
    ...
    function ue(t, e) {
        ...
        this.append = !1,
        this.$element = L(t).first(),
        P(document.body, this.$element[0]) || (this.append = !0,
        L("body").append(this.$element)),
        X(this.options, e),
    ...
    ue.prototype.transitionEnd = function() {
        ...
        this.triggerEvent("closed"),
        this.$element.hide(),
        re(he).length || de || !fe || (L.unlockScreen(),
        fe = !1),
    ...
    ue.prototype.destroy = function() {
        ...
        re(he).length || de || (ce && (L.hideOverlay(),
        ce = null),
        fe && (L.unlockScreen(),
        fe = !1))
    }
    ...
    function Ce(t, e) {
        ...
        X(this.options, e),
        this.$element = L('<div class="mdui-tooltip" id="' + L.guid() + '">' + this.options.content + "</div>").appendTo(document.body);
        var n = this;
    ...
    Ce.prototype.setPosition = function() {
        ...
        switch ("auto" === r && (r = n.top + n.height + i + s + 2 < yt.height() ? "bottom" : i + s + 2 < n.top ? "top" : i + o + 2 < n.left ? "left" : n.width + i + o + 2 < yt.width() - n.left ? "right" : "bottom"),
        r) {
        case "bottom":
            t = o / 2 * -1,
            e = n.height / 2 + i,
    ...
    L(function() {
        gt.on("touchstart mouseover", "[" + $e + "]", function() {
            var t = L(this)
              , e = t.data(Ee);
            e || (e = new B.Tooltip(this,Ct(this, $e)),
            t.data(Ee, e))
        })
    });
    function Oe(t) {
        ...
        this.$element = L('<div class="mdui-snackbar"><div class="mdui-snackbar-text">' + this.options.message + "</div>" + (this.options.buttonText ? '<a href="javascript:void(0)" class="mdui-snackbar-action mdui-btn mdui-ripple mdui-ripple-white ' + n + '" ' + e + ">" + this.options.buttonText + "</a>" : "") + "</div>").appendTo(document.body),
    ...
    Oe.prototype.open = function() {
        ...
        this.$element.transitionEnd(function() {
            ...
            e.options.closeOnOutsideClick && gt.on(jt, e.closeOnOutsideClick),
    ...
    Oe.prototype.close = function() {
        ...
        this.options.closeOnOutsideClick && gt.off(jt, this.closeOnOutsideClick),
        this.state = "closing",
    ...
    je.prototype.readjust = function() {
        var t, e, n, i, o, s, r = yt.height(), a = yt.width(), u = this.options.gutter, c = this.isCovered, l = this.options.fixed, d = this.$element.width(), h = this.$element.height(), f = this.$anchor[0].getBoundingClientRect(), p = f.top, m = f.left, v = f.height, g = f.width, y = r - p - v, b = a - m - g, x = this.$anchor[0].offsetTop, C = this.$anchor[0].offsetLeft;
    ...
    je.prototype.readjustSubmenu = function(t) {
        var e, n, i, o, s, r, a = t.parent(".mdui-menu-item"), u = yt.height(), c = yt.width(), l = t.width(), d = t.height(), h = a[0].getBoundingClientRect(), f = h.width, p = h.height, m = h.left, v = h.top;
            ...
            this.$element.on("mouseover mouseout", ".mdui-menu-item", function(t) {
                ...
                if (void 0 === e.attr("disabled")) {
                    if ("mouseover" === n) {
                        if (!e.is(i) && P(e[0], i[0]))
                            return
                    } else if ("mouseout" === n && (e.is(i) || P(e[0], i[0])))
                        return;
 ...
 * Original file: /gh/TransparentLC/WechatMomentScreenshot@37c480453d7fc4a8e42bd5e918a05d4658251496/main.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
...
function() {
    ...
    !function(e) {
        for (var t = o, n = e(); ; )
            try {
                if (470038 === -parseInt(t("0x147", "6wpg")) / 1 + -parseInt(t("0x153", "Y3gW")) / 2 * (-parseInt(t("0x139", "0bQb")) / 3) + -parseInt(t("0x129", "F@4q")) / 4 * (-parseInt(t("0x125", "2nA7")) / 5) + parseInt(t("0x12f", "[*cL")) / 6 * (-parseInt(t("0x157", "FmF8")) / 7) + -parseInt(t("0x12d", "[*cL")) / 8 + parseInt(t("0x12b", "E3oO")) / 9 * (-parseInt(t("0x138", "Gg40")) / 10) + parseInt(t("0x15b", "aJy7")) / 11 * (parseInt(t("0x150", "@L46")) / 12))
                    break;
                n.push(n.shift())
            } catch (e) {
                n.push(n.shift())
        ...
        return o = function(t, c) {
            ...
            if (void 0 === o.pYTORO) {
                o.IbbqAK = function(e, t) {
                    var n, o, c = [], d = 0, m = "";
                    for (e = function(e) {
                        for (var t, n, o = "", c = "", d = 0, m = 0; n = e.charAt(m++); ~n && (t = d % 4 ? 64 * t + n : n,
                        d++ % 4) ? o += String.fromCharCode(255 & t >> (-2 * d & 6)) : 0)
                            n = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(n);
                        for (var a = 0, i = o.length; a < i; a++)
                            c += "%" + ("00" + o.charCodeAt(a).toString(16)).slice(-2);
                        return decodeURIComponent(c)
                    }(e),
                    o = 0; o < 256; o++)
                        c[o] = o;
                    for (o = 0; o < 256; o++)
                        d = (d + c[o] + t.charCodeAt(o % t.length)) % 256,
                        n = c[o],
                        c[o] = c[d],
                        c[d] = n;
                    o = 0,
                    ...
                    for (var a = 0; a < e.length; a++)
                        ...
                        c[o] = c[d],
                        c[d] = n,
                        m += String.fromCharCode(e.charCodeAt(a) ^ c[(c[o] + c[d]) % 256]);
                    return m
                }
                ,
                e = arguments,
            ...
            var m = t + n[0]
              , a = e[m];
            return a ? d = a : (void 0 === o.DxvYnA && (o.DxvYnA = !0),
            d = o.IbbqAK(d, c),
            e[m] = d),
            d
        }
    ...
    if (n(this, (function() {
        ...
        for (var c = e[t("0x12a", "pE(y")] = e[t("0x13d", "52O&")] || {}, d = [t("0x14f", "P7zD"), t("0x126", "2nA7"), t("0x148", "aJy7"), t("0x135", "6ENc"), t("0x12e", "9(NJ"), t("0x14e", "[lnt"), t("0x13c", "4T4e")], m = 0; m < d[t("0x167", "4T4e")]; m++) {
            var a = n[t("0x149", "Y3gW")][t("0x142", "^zMp")][t("0x14a", "OpUZ")](n)
              , i = d[m]
              , r = c[i] || a;
            a[t("0x14b", "KZb$")] = n[t("0x136", "Gg40")](n),
            a[t("0x160", "Nevx")] = r[t("0x15d", "0bQb")][t("0x14c", "(^ZR")](r),
            c[i] = a
        }
    }
    ))(),
    location[e("0x137", "bk%3")] !== e("0x152", "44*Y") && location[e("0x154", "P7zD")] !== e("0x146", "XUUA")) {
        ...
        d[e("0x13b", "E3oO")](e("0x128", "MWnk"), e("0x124", "S0JU")),
        d[e("0x165", "bk%3")] = function() {
            var t = e;
            -1 !== d[t("0x144", "Gg40")][t("0x145", "E3oO")]()[t("0x155", "E3oO")]("\n")[t("0x13a", "9wme")]((function(e) {
...
-1 !== navigator.userAgent.toLowerCase().indexOf("micromessenger") && loadScript("https://cdn.jsdelivr.net/gh/TransparentLC/WechatMomentScreenshot/fuckWechat.min.js"),
window.Promise || loadScript("https://cdn.jsdelivr.net/npm/promise-polyfill/dist/polyfill.min.js");
var avatarURL = [];
...
for (var k in configDefault)
    void 0 === config[k] && (config[k] = configDefault[k]);
...
function clearMultiImage() {
    for (var e = 1; e <= 9; e++)
        document.getElementById("image" + e).style.backgroundImage = ""
}
...
xhrGet(config.avatarSet || "https://i.akarin.dev/wms-avatar/avatar-stable.txt", (function(e) {
    loadAvatarSet(e)
}
)),
document.getElementById("shareResourceCopy") && (document.getElementById("shareResourceCopy").onclick = function() {
    var e = document.createElement("div");
    e.style.opacity = 0,
    e.innerText = "https://wj.qq.com/s2/12913387/8254/",
    document.body.appendChild(e);
...
function addComment(e, t, n, o, c) {
    ...
    d.innerHTML = "<th>" + commentList.length + "</th><th>" + t + (c ? "（回复" + c + "）" : "") + "</th><th>" + n + "</th><th>" + o.toLocaleString() + "</th>",
    document.getElementById("configCommentList").append(d)
}
function removeComment() {
    commentList.length && (commentList.pop(),
...
function emoticonReplace(e) {
    e = e.replace(/\r?\n/g, "<br>");
    for (var t = 0; t < emoticon.length; t++)
        e = e.replace(new RegExp(emoticon[t].name,"g"), '<img class="emoticon" src="' + emoticon[t].URL + '">');
    return e
}
function randomName() {
...
function addPlayIcon() {
    Promise.all([new Promise((e => {
        ...
        ,
        t.src = document.getElementById("image").src
    }
    )), new Promise((e => {
        var t = new Image;
        t.onload = function() {
        ...
        c.drawImage(t, 0, 0),
        c.drawImage(n, t.width / 2 - o.width / 4 / 2, t.height / 2 - o.width / 4 / 2, o.width / 4, o.width / 4),
        o.toBlob((function(e) {
            URL.revokeObjectURL(document.getElementById("image").src),
            document.getElementById("image").src = URL.createObjectURL(e),
...
document.getElementById("configPostTimeHour").addEventListener("input", (function() {
    document.getElementById("configPostTimeHour").value > 23 ? document.getElementById("configPostTimeHour").value = 23 : document.getElementById("configPostTimeHour").value < 0 && (document.getElementById("configPostTimeHour").value = 0)
}
)),
document.getElementById("configPostTimeMinute").addEventListener("input", (function() {
    document.getElementById("configPostTimeMinute").value > 59 ? document.getElementById("configPostTimeMinute").value = 59 : document.getElementById("configPostTimeMinute").value < 0 && (document.getElementById("configPostTimeMinute").value = 0)
}
)),
document.getElementById("configScreenshotTimeHour").addEventListener("input", (function() {
    document.getElementById("configScreenshotTimeHour").value > 23 ? document.getElementById("configScreenshotTimeHour").value = 23 : document.getElementById("configScreenshotTimeHour").value < 0 && (document.getElementById("configScreenshotTimeHour").value = 0)
}
)),
document.getElementById("configScreenshotTimeMinute").addEventListener("input", (function() {
    document.getElementById("configScreenshotTimeMinute").value > 59 ? document.getElementById("configScreenshotTimeMinute").value = 59 : document.getElementById("configScreenshotTimeMinute").value < 0 && (document.getElementById("configScreenshotTimeMinute").value = 0)
}
)),
document.getElementById("configCommentTimeHour").addEventListener("input", (function() {
    document.getElementById("configCommentTimeHour").value > 23 ? document.getElementById("configCommentTimeHour").value = 23 : document.getElementById("configCommentTimeHour").value < 0 && (document.getElementById("configCommentTimeHour").value = 0)
}
)),
document.getElementById("configCommentTimeMinute").addEventListener("input", (function() {
    document.getElementById("configCommentTimeMinute").value > 59 ? document.getElementById("configCommentTimeMinute").value = 59 : document.getElementById("configCommentTimeMinute").value < 0 && (document.getElementById("configCommentTimeMinute").value = 0)
}
)),
document.getElementById("configLike").addEventListener("input", (function() {
    parseInt(document.getElementById("configLike").value) < 0 && (document.getElementById("configLike").value = 0)
}
)),
...
for (var i = 1; i <= 9; i++)
    !function(e) {
        document.getElementById("configSetMultiImage" + e).addEventListener("change", (function() {
            document.getElementById("image" + e).style.backgroundImage = 'url("' + URL.createObjectURL(this.files[0]) + '")'
        }
        ))
    }(i);
document.getElementById("generate").addEventListener("click", (function() {
    var e = document.getElementById("configUIWhite").checked;
    if (e ? (document.getElementById("fakeWechatMoment").classList.add("whiteUI"),
    ...
    document.querySelector("#footer > img").src = "mdicons/black_icons/emoticon.svg") : (document.getElementById("fakeWechatMoment").classList.remove("whiteUI"),
    ...
    "" == document.getElementById("configLocation").value ? document.getElementById("location").style.display = "none" : (document.getElementById("location").style.display = "inline",
    document.getElementById("location").innerText = document.getElementById("configLocation").value),
    document.getElementById("text").innerHTML = emoticonReplace(document.getElementById("text").innerText.replace(/((?:^|\s)#\S+(?:$|\s))/gm, '<span style="color:#576b95">$1</span>').replace(/(https?:\/\/(?:www\.)?[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b(?:[-a-zA-Z0-9()@:%_\+.~#?&//=]*))/g, '<span style="color:#576b95">$1</span>')),
    console.log(document.getElementById("text").innerHTML),
    document.getElementById("configTypeMultiImage").checked) {
        for (var t = 1; t <= 9; t++)
            document.getElementById("image" + t).style.display = "inline-block";
        var n = 0;
        for (n = 9; n >= 1 && "" == document.getElementById("image" + n).style.backgroundImage; n--)
            ;
        4 == n && (document.getElementById("image5").style.backgroundImage = document.getElementById("image4").style.backgroundImage,
        ...
        n = 5);
        for (t = n + 1; t <= 9; t++)
            document.getElementById("image" + t).style.display = "none"
    }
    if (document.getElementById("configTopBarCustom").checked)
        ...
        document.getElementById("topBarIconIos").src = "mdicons/" + (e ? "black_icons" : "white_icons") + "/ios_status.svg",
        ...
        document.getElementById("configTopBarStatusIcons").checked ? (document.getElementById("topBarIconWifi").src = "mdicons/" + (e ? "black_icons" : "white_icons") + "/ic_signal_wifi_" + o[Math.floor(Math.random() * o.length)] + "_bar_48px.svg",
        document.getElementById("topBarIconSignal").src = "mdicons/" + (e ? "black_icons" : "white_icons") + "/ic_signal_cellular_" + o[Math.floor(17 * Math.random())] + "_bar_48px.svg",
        document.getElementById("topBarIconBattery").src = "mdicons/" + (e ? "black_icons" : "white_icons") + "/ic_battery_" + (Math.random() > .75 ? "charging_" : "") + c[Math.floor(Math.random() * c.length)] + "_48px.svg") : (document.getElementById("topBarIconWifi").src = "mdicons/" + (e ? "black_icons" : "white_icons") + "/ic_signal_wifi_4_bar_48px.svg",
        document.getElementById("topBarIconSignal").src = "mdicons/" + (e ? "black_icons" : "white_icons") + "/ic_signal_cellular_4_bar_48px.svg",
        document.getElementById("topBarIconBattery").src = "mdicons/" + (e ? "black_icons" : "white_icons") + "/ic_battery_full_48px.svg");
        var d = [["qq", .5], ["wechat", .5], ["cloudmusic", .25], ["coolapk", .15], ["tieba", .15], ["acfun", .15]];
        if (d.sort((function() {
            return Math.random() > .5 ? 1 : -1
        }
        )),
        document.getElementById("topBarAppIcons").innerHTML = "",
        document.getElementById("configTopBarAppIcons").checked)
            for (t = 0; t < d.length; t++)
                Math.random() < d[t][1] && (document.getElementById("topBarAppIcons").innerHTML += '<img class="topBarIcon" src="mdicons/' + (e ? "black_icons" : "white_icons") + "/app_" + d[t][0] + '.svg">')
    }
    var m = document.getElementById("configPostDate").valueAsDate;
    m.setHours(document.getElementById("configPostTimeHour").value),
    m.setMinutes(document.getElementById("configPostTimeMinute").value);
    var a = document.getElementById("configScreenshotDate").valueAsDate;
    a.setHours(document.getElementById("configScreenshotTimeHour").value),
    a.setMinutes(document.getElementById("configScreenshotTimeMinute").value),
    document.getElementById("time").innerHTML = getTimeString(a, m),
    ...
    document.getElementById("configApp") && (document.getElementById("configApp").value.match(/视频号 *· *(.+)/g) ? document.getElementById("time").innerHTML += ' <span style="color:#576b95">视频号 · ' + /视频号 *· *(.+)/g.exec(document.getElementById("configApp").value)[1] + "</span>" : document.getElementById("time").innerHTML += " " + document.getElementById("configApp").value);
    var i, r = avatarURL.concat();
    document.getElementById("likeAvatarList").innerHTML = "";
    for (t = 0; t < parseInt(document.getElementById("configLike").value); t++) {
        if (0 === t && document.getElementById("configFirstAvatar").checked)
            i = document.getElementById("avatar").style.backgroundImage.replace(/url\("(.+?)"\)/g, "$1");
        else {
        ...
        u.setAttribute("class", "likeAvatar squareImage"),
        u.setAttribute("style", 'background-image:url("' + i + '")'),
        document.getElementById("likeAvatarList").appendChild(u)
    }
    if (document.getElementById("commentList").innerHTML = "",
    document.getElementById("configShowComment").checked && commentList.length) {
        document.getElementById("comment").style.display = "block";
        for (t = 0; t < commentList.length; t++) {
            var g = commentList[t];
            document.getElementById("commentList").innerHTML += '<div class="commentItem"><div class="commentAvatar squareImage" style="background-image: url(' + g.avatar + ');"></div><div class="content"><span class="commentName">' + g.name + '</span><span class="commentTime">' + getTimeString(a, g.date) + '</span><div class="commentText">' + (g.reply ? '回复<span style="color:#576b95">' + g.reply + "</span>: " : "") + emoticonReplace(g.content) + "</div></div></div>"
        }
    } else
        document.getElementById("comment").style.display = "none";
    var s = Number(document.getElementById("configHeight").value);
    document.getElementById("fakeWechatMoment").style.display = "block",
    document.getElementById("fakeWechatMoment").style.width = "1080px",
    document.getElementById("fakeWechatMoment").style.height = (window.getComputedStyle(document.getElementById("fakeWechatMoment")).height.replace("px", "") > s ? window.getComputedStyle(document.getElementById("fakeWechatMoment")).height.replace("px", "") : s) + "px",
    document.getElementById("like").style.display = parseInt(document.getElementById("configLike").value) ? "block" : "none";
    var W = 26 + Number(window.getComputedStyle(document.getElementById("topBar")).height.replace("px", "")) + Number(window.getComputedStyle(document.getElementById("header")).height.replace("px", "")) + Number(window.getComputedStyle(document.getElementById("main")).height.replace("px", ""));
    document.getElementById("footer").style.bottom = (W < s - Number(window.getComputedStyle(document.getElementById("footer")).height.replace("px", "")) ? -s + Number(window.getComputedStyle(document.getElementById("footer")).height.replace("px", "")) + W : 0) + "px",
    ...
    function() {
        ...
        function t(e, o) {
            ...
            return t = function(n, o) {
                ...
                var m = n + c[0]
                  , a = e[m];
                return a ? d = a : (void 0 === t.MUIPgx && (t.MUIPgx = !0),
                d = t.WLKDLW(d, o),
                e[m] = d),
                d
            }
        ...
        !function(e) {
            for (var n = t, o = e(); ; )
                try {
                    if (300758 === -parseInt(n(562, "iEA9")) / 1 + parseInt(n(616, "lIsT")) / 2 * (parseInt(n(534, "zl5J")) / 3) + -parseInt(n(544, "627!")) / 4 + parseInt(n(475, "W%&c")) / 5 * (-parseInt(n(588, "NvGH")) / 6) + -parseInt(n(611, "wFuy")) / 7 * (parseInt(n(553, "j$fY")) / 8) + parseInt(n(519, "wFuy")) / 9 * (parseInt(n(618, "gh*r")) / 10) + parseInt(n(444, "u5(c")) / 11)
                        break;
                    o.push(o.shift())
                } catch (e) {
                    o.push(o.shift())
        ...
        var o = Promise[e(524, "fsx[")]();
        -1 === document[e(523, "lIsT")](e(529, "QDSw"))[e(615, "*U(%")][e(535, "jAh#")](e(432, "7Wxi")) || document[e(434, "eFhz")](e(485, "6h#Z"))[e(500, "6vS(")] !== e(477, "gNbt") || document[e(551, "hHlX")](e(465, "CAu1"))[e(466, "4w3C")] !== e(481, "]riB") ? o = o[e(443, "sMmP")]((function() {
            var t = e;
            return Promise[t(487, "iEA9")](t(445, "k(fK"))
        }
        )) : location[e(538, "jAh#")] !== e(440, "hHlX") && location[e(514, "7#MU")] !== e(578, "dZR&") && 3506411380 !== function(e) {
            for (var n = t, o = 2166136261, c = 0; c < e[n(561, "7#MU")]; c++)
                o ^= e[n(628, "(F^g")](c),
            ...
            var e = t;
            if (navigator[e(522, "zl5J")] || navigator[e(612, "gh*r")](e(614, "&u&u")))
                return !0;
            ...
            for (var c in o)
                if (window[o[c]])
                    return !0;
            for (const t in n)
                if (window[e(566, "iEA9")][n[t]])
                    return !0;
            for (const t in window[e(504, "hHlX")])
                if (t[e(439, "ueOA")](/\$[a-z]dc_/) && window[e(592, "&u&u")][t][e(559, "LCog")])
                    return !0;
        ...
        o = o[e(516, "6vS(")]((function() {
            ...
            var n = e
              , o = t[n(554, "tuFY")]();
            document[n(450, "ueOA")](n(461, "tuFY"))[n(452, "u5(c")] = o,
            document[n(543, "2]%t")](n(586, "LCog"))[n(499, "G(PT")](n(486, "k(fK"), o),
            document[n(476, "NvGH")](n(478, "gh*r"))[n(490, "QDSw")](n(540, "7#MU"), +new Date + n(480, "6vS(")),
            document[n(471, "wFuy")](n(590, "zl5J")) && new (mdui[n(541, "&u&u")])(document[n(455, "cFaV")](n(580, "k(fK")))[n(537, "gNbt")](),
            new (mdui[n(502, "L3f*")])(document[n(603, "6h#Z")](n(621, "zl5J")))[n(488, "7Wxi")]();
            var c = {
            ...
            if (localStorage[n(555, "(F^g")](n(602, "qX2S"), JSON[n(493, "d0VK")](c)),
            avatarFile) {
                var d = new FileReader;
                d[n(631, "eFhz")](avatarFile),
                d[n(497, "fsx[")] = function() {
                    var e = n;
            ...
            var t = e;
            document[t(626, "dZR&")](t(585, "u5(c"))[t(552, "qX2S")](t(589, "WJO1")),
            document[t(626, "dZR&")](t(508, "G(PT"))[t(510, "G(PT")] = "生成"
        }
        ))
    }()
}
));
//# sourceMappingURL=/sm/c8f9628c66b4cd20503145c7946027db2592f2b45a34e7d25e15eb8a943dc0b3.map
